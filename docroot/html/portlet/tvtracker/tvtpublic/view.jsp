...
<%
	...
	TvTrackerPublicSearch tvTrackerPublicSearch = new TvTrackerPublicSearch(renderRequest, portletURL);
%>

<div id="<portlet:namespace/>TvTrackerPublicContainer">
	<aui:fieldset>
		<liferay-ui:search-container
			searchContainer="<%= tvTrackerPublicSearch %>" 
			iteratorURL="<%= tvTrackerPublicSearch.getIteratorURL() %>" >
